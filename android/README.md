...
```gradle
dependencies {
    implementation 'com.github.apiverve:earnings-api:1.1.14'
}
```
...
```java
import com.apiverve.earnings.EarningsReportAPIClient;
import com.apiverve.earnings.APIResponse;
import com.apiverve.earnings.APIException;

// Initialize the client
EarningsReportAPIClient client = new EarningsReportAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("ticker", "ADBE");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/earnings](https://docs.apiverve.com/ref/earnings)
...
- **Documentation:** [https://docs.apiverve.com/ref/earnings](https://docs.apiverve.com/ref/earnings)
- **Issues:** [GitHub Issues](https://github.com/apiverve/earnings-api/issues)
