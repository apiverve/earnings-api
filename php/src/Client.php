...
/**
 * Client for the Earnings Report API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/earnings?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/earnings';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\EarningsClient] {$message}\n";
        }
    }
}
