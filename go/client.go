...
const (
	baseURL        = "https://api.apiverve.com/v1/earnings"
	defaultTimeout = 30 * time.Second
)

// Client is the Earnings Report API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Earnings Report API client.
...
// Execute makes a request to the Earnings Report API with typed parameters.
//
