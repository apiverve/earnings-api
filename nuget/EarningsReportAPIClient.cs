...
namespace APIVerve.API.EarningsReport
{
    ...
    /// <summary>
    /// Client for the EarningsReport API
    /// </summary>
    public class EarningsReportAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/earnings";
        ...
        {
            { "ticker", new ValidationRule { Type = "string", Required = true, MinLength = 1, MaxLength = 5 } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 2000, Max = 2030 } },
            { "quarter", new ValidationRule { Type = "integer", Required = false, Min = 1, Max = 4 } }
        };
        ...
        public EarningsReportAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public EarningsReportAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public EarningsReportAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, EarningsReportQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(EarningsReportQueryOptions options)
        {
        ...
        public ResponseObj Execute(EarningsReportQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(EarningsReportQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(EarningsReportQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(EarningsReportQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(EarningsReportQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(EarningsReportQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(EarningsReportQueryOptions options)
        {
